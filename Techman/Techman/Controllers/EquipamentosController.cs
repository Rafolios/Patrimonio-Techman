...
namespace Techman.Controllers
{
    public class EquipamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Equipamento,Imagem,Descriçao,Ativo,Data")] Equipamentos equipamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Equipamento,Imagem,Descriçao,Ativo,Data")] Equipamentos equipamentos)
        {
